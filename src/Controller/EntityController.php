...
abstract class EntityController extends AbstractController
{
    ...
    {
        $this->preActionSetup($request, 'view');
    ...
    {
        $this->preActionSetup($request, 'edit');
     ...
     * The following could handle many actions (view, edit, delete, etc.):
     *
     * eg. entity_action:
     ...
     * must have a callable method viewAction(), editAction(), deleteAction(), etc.
     */
    ...
    {
        throw new LogicException(sprintf('Please override \%s() or %s()', __METHOD__, '::viewAction'));
    }
